...
# Five rows per letter, five columns wide. The whole alphabet, because it did
# not used to be: the set covered the letters in "CRAWLER" and every other
# title was rendered with holes in it - SETTINGS came out as "SE  I  S", SOAK
# as "S A ", HALL as " ALL". A screen title is not the place to discover that
# a lookup falls back to blanks.
